...
const NftItemPage = async ({ params: { id: nftId } }: Props) => {
  ...
  const nftContractAddress =
    process.env.NEXT_PUBLIC_CONTRACT_NFT_ADDRESS!.toLowerCase();
      ...
      <div className="lg:col-span-2">
        ...
        <BoxFrame className="p-16 mt-4">
          ...
          <div className="flex items-center justify-between mt-3">
            ...
            >
              <span className="font-bold text-[32px] text-white hover:text-primary transition-colors">
                {nftContractAddress!.slice(0, 6)}...
                {nftContractAddress!.slice(-4)}
              </span>
            </Link>
          </div>
          <div className="flex items-center justify-between mt-3">
        ...
        <BoxFrame className="p-16 mt-4 text-[#6B7280] text-[24px]">
          ...
          <p>
            3.The market will charge 3% of the seller’s revenue as a service
            fee, of which 50% is burned, 40% enters the NFT Pool, and 10% is the
            developer’s revenue;
          </p>
        </BoxFrame>
      </div>
